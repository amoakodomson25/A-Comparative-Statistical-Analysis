...
tryCatch({
  ...
  # Calculate means in wide format directly
  result_table <- clean_data %>%
    ...
    arrange(Education)  # Ensure proper ordering
  
  # Print the formatted table
  cat("\nMean number of individuals by Education level:\n")
  print(result_table, n = Inf)  # Print all rows
